...
//         content: TextField(controller: controller, decoration: InputDecoration(hintText: "Enter $field")),
//         actions: [
...
//                                 onPressed: () => showEditDialog('name', userData!['name'] ?? ''),
//                               ),
//                             ],
//                           ),
//                         ],
...
//                               IconButton(
//                                 icon: const Icon(Icons.edit, size: 18),
//                                 onPressed: () => showEditDialog('username', userData!['username'] ?? ''),
//                               ),
//                             ],
//                           ),
//                         ],
...
// // ✅ Provider Class (keep it in same file as per your style)
