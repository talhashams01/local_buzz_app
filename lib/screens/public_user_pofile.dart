...
//   late Stream<QuerySnapshot> _userReadsStream;

//   @override
//   void initState() {
//     super.initState();
//     _userFuture = FirebaseFirestore.instance.collection('users').doc(widget.userId).get();
//     _userReadsStream = FirebaseFirestore.instance
//         .collection('reads')
...
//                         child: Row(
//                           children: [
//                             Text("Posts: $count", style: const TextStyle(fontWeight: FontWeight.w500)),
//                           ],
//                         ),
//                       ),
...
//   setState(() {}); // ✅ Rebuild to reflect change immediately
// }
...
//                       // Bottom: Likes, Comments, Location
//                       Row(
//                         mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                         children: [
//                           // Likes + Comments
